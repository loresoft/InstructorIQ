...
export class AuthenticationService {
  ...
  @bindable tenantId: string;
  @bindable tenantName: string;
  ...
  async login(email: string, password: string, tenant?: string): Promise<TokenResult> {
  ...
  async accessToken(): Promise<string>{
    const isAuthenticated = await this.checkToken();
    if (isAuthenticated){
  ...
  processToken(token: TokenResponse) {
    ...
    if (this.payload) {
      ...
      this.tenantId = this.payload.oid;
      this.tenantName = this.payload.org;
    } else {
