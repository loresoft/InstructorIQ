...
namespace InstructorIQ.Core.Data.Queries
{
    ...
    public static partial class InstructorExtensions
    {
        ...
        /// <param name="id">The value to filter by.</param>
        /// <returns>An instance of <see cref="T:InstructorIQ.Core.Data.Entities.Instructor"/> or null if not found.</returns>
        public static ValueTask<InstructorIQ.Core.Data.Entities.Instructor> GetByKeyAsync(this IQueryable<InstructorIQ.Core.Data.Entities.Instructor> queryable, Guid id)
        {
            if (queryable is DbSet<InstructorIQ.Core.Data.Entities.Instructor> dbSet)
                return dbSet.FindAsync(id);

            var task = queryable.FirstOrDefaultAsync(q => q.Id == id);
            return new ValueTask<InstructorIQ.Core.Data.Entities.Instructor>(task);
        }
