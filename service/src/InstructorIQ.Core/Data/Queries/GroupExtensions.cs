...
public static partial class GroupExtensions
{
    ...
    /// <returns>An instance of <see cref="T:InstructorIQ.Core.Data.Entities.Group"/> or null if not found.</returns>
    public static async System.Threading.Tasks.ValueTask<InstructorIQ.Core.Data.Entities.Group> GetByKeyAsync(this System.Linq.IQueryable<InstructorIQ.Core.Data.Entities.Group> queryable, Guid id, System.Threading.CancellationToken cancellationToken = default)
    {
        if (queryable is null)
            throw new ArgumentNullException(nameof(queryable));
    ...
    public static System.Linq.IQueryable<InstructorIQ.Core.Data.Entities.Group> ByName(this System.Linq.IQueryable<InstructorIQ.Core.Data.Entities.Group> queryable, string name)
    {
        if (queryable is null)
            throw new ArgumentNullException(nameof(queryable));
    ...
    /// <returns>An <see cref="T: System.Linq.IQueryable`1" /> that contains elements from the input sequence that satisfy the condition specified.</returns>
    public static System.Linq.IQueryable<InstructorIQ.Core.Data.Entities.Group> ByTenantId(this System.Linq.IQueryable<InstructorIQ.Core.Data.Entities.Group> queryable, Guid tenantId)
    {
        if (queryable is null)
            throw new ArgumentNullException(nameof(queryable));
