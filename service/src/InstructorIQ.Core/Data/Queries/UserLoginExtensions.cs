...
{
    /// <summary>
    /// Query extensions for entity <see cref="InstructorIQ.Core.Data.Entities.UserLogin" />.
    /// </summary>
    public static partial class UserLoginExtensions
    {
        ...
        public static InstructorIQ.Core.Data.Entities.UserLogin GetByKey(this IQueryable<InstructorIQ.Core.Data.Entities.UserLogin> queryable, Guid id)
        {
            if (queryable is DbSet<InstructorIQ.Core.Data.Entities.UserLogin> dbSet)
        ...
        /// <param name="id">The value to filter by.</param>
        /// <returns>An instance of <see cref="T:InstructorIQ.Core.Data.Entities.UserLogin"/> or null if not found.</returns>
        public static Task<InstructorIQ.Core.Data.Entities.UserLogin> GetByKeyAsync(this IQueryable<InstructorIQ.Core.Data.Entities.UserLogin> queryable, Guid id)
        {
            if (queryable is DbSet<InstructorIQ.Core.Data.Entities.UserLogin> dbSet)
