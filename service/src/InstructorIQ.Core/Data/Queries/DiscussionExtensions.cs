...
namespace InstructorIQ.Core.Data.Queries
{
    ...
    public static partial class DiscussionExtensions
    {
        ...
        /// <param name="id">The value to filter by.</param>
        /// <returns>An instance of <see cref="T:InstructorIQ.Core.Data.Entities.Discussion"/> or null if not found.</returns>
        public static ValueTask<InstructorIQ.Core.Data.Entities.Discussion> GetByKeyAsync(this IQueryable<InstructorIQ.Core.Data.Entities.Discussion> queryable, Guid id)
        {
            if (queryable is DbSet<InstructorIQ.Core.Data.Entities.Discussion> dbSet)
                return dbSet.FindAsync(id);

            var task = queryable.FirstOrDefaultAsync(q => q.Id == id);
            return new ValueTask<InstructorIQ.Core.Data.Entities.Discussion>(task);
        }
