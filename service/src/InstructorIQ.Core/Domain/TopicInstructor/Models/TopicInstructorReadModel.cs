...
namespace InstructorIQ.Core.Domain.Models
{
    ...
    /// View Model class
    /// </summary>
    public partial class TopicInstructorReadModel
        : EntityReadModel<Guid>
    {
        ...
        public string InstructorGivenName { get; set; }

        public string InstructorFamilyName { get; set; }

        public string InstructorDisplayName { get; set; }

        public string InstructorSortName { get; set; }
