...
{
    /// <summary>
    /// Validator class for <see cref="AuthenticationEventCreateModel"/> .
    /// </summary>
    public partial class AuthenticationEventCreateModelValidator
        : AbstractValidator<AuthenticationEventCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticationEventCreateModelValidator"/> class.
        /// </summary>
        public AuthenticationEventCreateModelValidator()
        {
