...
{
    public class AuthenticateEntityPatchCommandBehavior<TEntity, TReadModel> : PipelineBehaviorBase<EntityPatchCommand<TEntity, TReadModel>, TReadModel>
        where TEntity : class, new()
        where TReadModel : EntityReadModel
    {
        public AuthenticateEntityPatchCommandBehavior(ILoggerFactory loggerFactory) : base(loggerFactory)
        {
        }
