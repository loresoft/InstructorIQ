...
{
    public class AuthenticateEntityUpdateCommandBehavior<TEntity, TUpdateModel, TReadModel> : PipelineBehaviorBase<EntityUpdateCommand<TEntity, TUpdateModel, TReadModel>, TReadModel>
        where TEntity : class, new()
        where TUpdateModel : EntityUpdateModel
        where TReadModel : EntityReadModel
    {
        public AuthenticateEntityUpdateCommandBehavior(ILoggerFactory loggerFactory) : base(loggerFactory)
        {
        }
