...
{
    public class TrackChangeEntityUpdateCommandBehavior<TEntity, TUpdateModel, TReadModel> : IPipelineBehavior<EntityUpdateCommand<TEntity, TUpdateModel, TReadModel>, TReadModel>
