...
namespace InstructorIQ.Web.Controllers
{
    ...
    public class LocationController : MediatorCommandControllerBase<Guid, LocationReadModel, LocationCreateModel, LocationUpdateModel>
    {
        ...
        [HttpPost("")]
        [ProducesResponseType(typeof(LocationReadModel), 200)]
        public async Task<IActionResult> Create(CancellationToken cancellationToken, LocationCreateModel createModel)
        {
        ...
        [HttpPut("{id}")]
        [ProducesResponseType(typeof(LocationReadModel), 200)]
        public async Task<IActionResult> Update(CancellationToken cancellationToken, Guid id, LocationUpdateModel updateModel)
        {
