...
namespace InstructorIQ.Web.Controllers
{
    ...
    public class GroupController : MediatorCommandControllerBase<Guid, GroupReadModel, GroupCreateModel, GroupUpdateModel>
    {
        ...
        [HttpPost("")]
        [ProducesResponseType(typeof(GroupReadModel), 200)]
        public async Task<IActionResult> Create(CancellationToken cancellationToken, GroupCreateModel createModel)
        {
        ...
        [HttpPut("{id}")]
        [ProducesResponseType(typeof(GroupReadModel), 200)]
        public async Task<IActionResult> Update(CancellationToken cancellationToken, Guid id, GroupUpdateModel updateModel)
        {
        ...
        [HttpPatch("{id}")]
        [ProducesResponseType(typeof(GroupReadModel), 200)]
        public async Task<IActionResult> Patch(CancellationToken cancellationToken, Guid id, JsonPatchDocument<Group> jsonPatch)
        {
