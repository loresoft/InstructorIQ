...
namespace InstructorIQ.WebApplication.Pages.Topic.Messaging
{
    ...
    public class PlanUpdateModel : EntityIdentifierModelBase<TopicUpdateModel>
    {
        ...
        public PlanUpdateModel(ITenant<TenantReadModel> tenant, IMediator mediator, ILoggerFactory loggerFactory, IEmailTemplateService templateService, UserClaimManager userClaimManager) 
